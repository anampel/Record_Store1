...
namespace Record_Store.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.ReportsTo = new SelectList(db.Employee, "EmployeeId", "LastName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,LastName,FirstName,Title,ReportsTo,BirthDate,HireDate,Address,City,State,Country,PostalCode,Phone,Fax,Email")] Employee employee)
        {
            ...
            ViewBag.ReportsTo = new SelectList(db.Employee, "EmployeeId", "LastName", employee.ReportsTo);
            return View(employee);
        }
        ...
        public ActionResult TracksPage()
        {
